#include "Enchantments_NPC.h"

class Enchantments_NPC : public CreatureScript
{
public:
    Enchantments_NPC() : CreatureScript("Enchantments_NPC") { }
...
void AddSC_Enchantments_NPC()
{
    new Enchantments_NPC();
}